...
RUN wget -O models/Stable-diffusion/model.ckpt 'https://huggingface.co/OfficialUnstableDiffusion/UnstablePhotoRealv.5/resolve/main/unstablephotorealv5_05.ckpt'
RUN echo 2
ADD prepare.py .
